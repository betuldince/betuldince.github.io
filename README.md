...
Languages : C, C++, C#, Java, PHP, NodeJS, MATLAB, Python, Ruby, HTML/CSS,  Verilog

Database Management Systems: MySQL, PostgreSQL, MongoDB, Oracle Database

Programs : Unity, Blender,REACT, Adobe Photoshop, Illustrator, Premiere, XD, Figma, TouchDesigner, Arduino, Microsoft Office Programs

Interests : Climbing, Oil painting, playing piano, drum and guitar, swing dancing, ice skating, cycling, radio broadcasting, volunteering.
